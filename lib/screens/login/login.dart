...
import 'package:boombox/screens/login/login_cubit.dart';
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  BlocBuilder<LoginCubit,LoginState>(
                      builder: (context,state){
                        ...
                        return TextButton(
                          ...
                          style: ButtonStyle(
                              backgroundColor: WidgetStateProperty.all(const Color(0xffee3483)),
                  ...
                  RichText(
                    text: TextSpan(
                        text: "By logging in, you agree to the Hiphopboombox",
